...
public class Fatura {
	 ...
	 * @param id_ped_serv
	 */
	public Fatura(int idFatura, double valor, LocalDate dataDaFatura, LocalDate dt_paga, double vl_multa, String stats,
			String tp_fatura, int id_ped_serv) {
		super();
