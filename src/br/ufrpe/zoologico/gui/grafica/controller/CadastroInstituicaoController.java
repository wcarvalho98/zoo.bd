...
public class CadastroInstituicaoController implements Initializable {
	...
	@FXML
	private RadioButton escolaRadioButton;

	@FXML
	private RadioButton empresaRadioButton;
	...
	void confirmarCadastro() {
		if (!nomeUsualTextField.getText().equals("") && !cnpjTextField.getText().equals("")
				&& !razaoSocialTextField.getText().equals("") && !emailTextField.getText().equals("")
				&& !telefone1TextField.getText().equals("") && !telefone2TextField.getText().equals("")) {
			if (escolaRadioButton.isSelected()) {
				Fachada.getInstance()
						.cadastrarInstituicao(new Instituicao(cnpjTextField.getText(), nomeUsualTextField.getText(),
								emailTextField.getText(), telefone1TextField.getText(), telefone2TextField.getText(),
								razaoSocialTextField.getText(), "Escola"));
				esvaziarCampos();
			} else if (empresaRadioButton.isSelected()) {
				Fachada.getInstance()
						.cadastrarInstituicao(new Instituicao(cnpjTextField.getText(), nomeUsualTextField.getText(),
								emailTextField.getText(), telefone1TextField.getText(), telefone2TextField.getText(),
								razaoSocialTextField.getText(), "Empresa"));
				esvaziarCampos();
			} else {
	...
	private void preencherTabela() {
		...
		colunaRazaoSocial
				.setCellValueFactory(new Callback<CellDataFeatures<Instituicao, String>, ObservableValue<String>>() {
					@Override
					public ObservableValue<String> call(CellDataFeatures<Instituicao, String> todosAsInstituicoes) {
