...
public class ScreenManager {
	...
	/**
	 * Metodo: getTelaReserva
	 * @return telaReserva
	 */
	public Scene getTelaReserva() {
		try {
			telaReserva = new Scene(FXMLLoader
					.load(getClass().getResource("/br/ufrpe/zoologico/gui/grafica/FXML/GerenciarReserva.fxml")));
